<script src="{{ asset('sk-assets/plugins/dropzone/dropzone.js') }}"></script>
				...
				<div class="row">
					<div class="col-xs-3 col-sm-3 col-md-3">
						<div class="fm_folder_selector">
							<form action="{{ url(config('skato-admin.adminRoute') . '/upload_files')}}" id="fm_dropzone" enctype="multipart/form-data" method="POST">
								{{ csrf_field() }}
								...
								@if(!config('skato-admin.uploads.private_uploads'))
									...
									{{ Form::checkbox("public", "public", config("skato-admin.uploads.default_public"), []) }}

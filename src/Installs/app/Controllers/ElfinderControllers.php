...
class ElfinderControllers extends Controller
{
    ...
    public function __construct(Application $app)
    {
        ...
        if (!\Auth::user()->hasRole('SUPER_ADMIN')){
            \Config::set('elfinder.roots.0.path', 'users/' . Str::slug(\Auth::user()->name, '_') . '-' . \Auth::user()->id);
            \Config::set('elfinder.roots.1.path', 'shared/' . Str::slug(\Auth::user()->employee->department->name, '_'));
        }
    }
